...
DAG_ID="dont-merge-this-test-dag1"

ENV_ID = os.environ.get("SYSTEM_TESTS_ENV_ID")


with DAG(dag_id=DAG_ID, schedule=None, start_date=pendulum.datetime(2023, 1, 1, tz="UTC"),
         default_args={"retries": 0}, catchup=False) as dag:
